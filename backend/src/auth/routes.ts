...
import { resendOTPControler, signupController, verifyOTPController } from "./controllers/signup.controller";
...
router.post('/resend-otp/:email', validateParams(ResendOTPDTO), resendOTPControler);
